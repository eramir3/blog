...
$("input[name='twitter_username']").keyup(function () {
    $(this).css('border-color', '#ccc');
    $(this).next().remove('div');
});
...
$("form").submit(function(e) {
    ...
    $("input[name='username']").next().remove('div');
    $("input[name='username']").css('border-color', '#ccc');

    $("input[name='twitter_username']").next().remove('div');
    $("input[name='twitter_username']").css('border-color', '#ccc');
    ...
    $("input[name='password_confirmation']").next().remove('div');
    $("input[name='password_confirmation']").css('border-color', '#ccc');
    ...
    .fail(function(error) {
        ...
        for(index in fieldNames) {
            ...
            toastr.error(fieldErrorMessage, "Registration Failed");
        }
    });
});